...
#include "../../Application/STM32N6570-DK/Inc/app_config.h"
#include <assert.h>
#include <stdint.h>

#if POSTPROCESS_TYPE == POSTPROCESS_OD_YOLO_V5_UU
static od_pp_outBuffer_t out_detections[AI_OD_ST_YOLOX_PP_MAX_BOXES_LIMIT];
...
int32_t app_postprocess_init(void *params_postprocess, NN_Instance_TypeDef *NN_Instance)
{
  ...
  params->nb_total_boxes = AI_OD_ST_YOLOX_PP_MAX_BOXES_LIMIT;
